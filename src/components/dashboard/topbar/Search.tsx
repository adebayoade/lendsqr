...
export default function Search() {
  return (
    <div className="relative flex h-[40px] w-[400px]">
      <input type="text" className="w-full" placeholder="Search for anything" name="search" />

      <button className="cursor-pointer w-[50px] absolute right-0 h-[40px] bg-secondary font-bold text-sm">
        <span className="flex h-[40px] flex-col items-center justify-center">
          <svg
            width="14"
            height="14"
            viewBox="0 0 14 14"
